...
**Type**: Positive test | **Precondition**: ISSM-16 + some narratives authored
...
### ISSM-23: Create POA&M

**Task**: Create a Plan of Actions & Milestones item
**Type**: Positive test | **Precondition**: Findings exist from assessment
...
**Note**: Replace `{finding_id}` with an actual finding ID from ISSM-19 or ISSM-20 import.
...
**Verification**: Status = "Ongoing", finding linked
...
**Type**: Positive test | **Precondition**: ISSM-23
...
**Type**: Positive test | **Precondition**: SSP, SAR, RAR, POA&M exist
...
**Type**: Positive test | **Precondition**: System with baseline + assessment
...
**Type**: Positive test | **Precondition**: ISSM-19 + remediation completed
